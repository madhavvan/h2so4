...
6. [Auto-Type — answers typed into your editor (Ultra & Enterprise)](#6-auto-type--answers-typed-into-your-editor-ultra--enterprise)
7. [Train Model — pre-research the role (Max, Ultra & Enterprise)](#7-train-model--pre-research-the-role-max-ultra--enterprise)
...
13. [Reasoning-effort knob (Max, Ultra & Enterprise)](#13-reasoning-effort-knob-max-ultra--enterprise)
...
## 6. Auto-Type — answers typed into your editor (Ultra & Enterprise)

Available on the Ultra and Enterprise plans — the two monthly subscriptions. Click the Auto-Type icon, then click into your code editor (the IDE, online judge, or coding sandbox). The AI's answer types into the editor at a realistic human cadence with natural pauses and corrections.
...
## 7. Train Model — pre-research the role (Max, Ultra & Enterprise)

Available on the Max, Ultra, and Enterprise plans. Before your interview, click **Train Model** in the chat sidebar. The app reads your résumé and the job description, then prepares a memory pack covering:
...
- **Claude** (Anthropic) — strongest on long-form reasoning and code. Available on Pro, Max, Ultra, and Enterprise; includes web search. Basic is the only paid plan without Claude.
...
## 13. Reasoning-effort knob (Max, Ultra & Enterprise)

For Max, Ultra, and Enterprise users on the GPT-5.6 model. The reasoning slider in the chat header has three notches:
...
- **United States and most countries** — USD via Stripe: Basic/Pro/Max as one-time interview passes, Ultra and Enterprise as the monthly subscriptions.
- **India** — INR via Razorpay (same shapes: one-time passes + the monthly subscriptions). While our Razorpay merchant account is being provisioned, Indian checkouts run through Stripe in USD instead.
...
**Basic, Pro, and Max are one-time interview passes** (use within 30 days); **Ultra and Enterprise are monthly subscriptions** — Ultra meters 9 hours per billing cycle, Enterprise has no cap.
...
| Extend on interview day | — | +30 min / +1 h / +3 h packs | Same packs | Same packs | Same packs | Not needed |
| AI models | 4 during trial (no Claude) | Gemini, GPT-5.6, Grok, Groq | All 5 (+ Claude) | All 5 | All 5 | All 5 |
| Knowledge files | 1 | Unlimited | Unlimited | Unlimited | Unlimited | Unlimited |
| Pop-out window | — | ✓ | ✓ | ✓ | ✓ | ✓ |
| Auto-Solve | — | ✓ | ✓ | ✓ | ✓ | ✓ |
| Auto-Type | — | — | — | — | ✓ | ✓ |
| Train Model | — | — | — | ✓ | ✓ | ✓ |
...
| Devices | 2 | 2 | 3 | 5 | 10 | 25 |
| Minica support chatbot | Scripted FAQ | Full AI chat | Full AI chat | Full AI chat | Full AI chat | Full AI chat |
